...
//leftlistbarcomponent shows category
import LeftListBarComponent from '../../Components/LeftListBar';
//categoryname
//we make custom hooks when click to genre ,through which we pass the category which is selected what is the id of that with usereudcer
...
const  MoviesContainer = ()=>{
    ...
    //lifecycle hook
    useEffect(()=>{
        //for filter, category clicked ,page chang
        GetDataTrending();
        //eslint-disable-next-line
    }, [pageno, genreforURL])
