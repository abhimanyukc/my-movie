...
//props through data coming from user type
const SearchBarCardComponents = ({searchValue, setSearchValue, typeValue, setTypeValue, filterData})=>{
    
    //here we getting data from parent component to child component,in child component  we update data to parent componet as a function
